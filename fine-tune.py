...
if __name__ == '__main__':
  data_dir = 'data/ImageNetDogs/Images'
  work_dir = 'working'
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='{}/finetuned_graph.pb'.format(work_dir),
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='{}/intermediate_graph/'.format(work_dir),
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='{}/finetuned_labels.txt'.format(work_dir),
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='{}/training_summaries'.format(work_dir),
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='pretrained/{}'.format(default_architecture),
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='{}/bottleneck'.format(work_dir),
